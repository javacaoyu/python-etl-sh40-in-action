...
class LogService:
    ...
    @staticmethod
    def __write_to_csv(model_list):
        logs_output_csv_path = str_util.unite_path_slash(
            project_config.log_output_csv_path+'/logs_'+time_util.get_time("%Y%m%d_%H%M%S"))
        with open(logs_output_csv_path, 'w', encoding="UTF-8") as f:
