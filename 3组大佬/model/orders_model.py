...
class OrdersModel:
    ...
    def __init__(self, data_str: str):
        ...
        self.order_detail_model_list = []
        for i in data['product']:
            model = OrdersDetailModel(data['orderID'],i)
            self.order_detail_model_list.append(model)
...
class OrdersDetailModel:
    def __init__(self, order_id, dict1):
        self.order_id = order_id
        self.barcode = dict1['barcode']
        self.name = dict1['name']
        self.count = dict1['count']
        self.price_per = dict1['pricePer']
        self.retail_price = dict1['retailPrice']
        self.trade_price = dict1['tradePrice']
        self.category_id = dict1['categoryID']
        self.unit_id = dict1['unitID']
    ...
    @staticmethod
    def get_csv_header():
        orders_detail_header_str = f"orderID{project_config.csv_output_sep}" \
